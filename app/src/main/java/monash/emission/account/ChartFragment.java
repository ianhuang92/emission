...
public class ChartFragment extends Fragment {
    ...
    private class mComparator implements Comparator
    {
        ...
        public int compare(Object o1, Object o2) {
            EmissionRecord record1 = (EmissionRecord)o1;
            EmissionRecord record2 = (EmissionRecord)o2;
            return record1.getStartdate().compareTo(record2.getStartdate());
        }
    }
    ...
    private void plot()
    {
        ...
        Collections.sort(tempList,new mComparator());
        for (EmissionRecord emissionRecord: tempList){
            if (emissionRecord.getName().equalsIgnoreCase("CO")) {  /*CO*/
                ...
                labels.add(mSdf.format(emissionRecord.getStartdate()) + "\nto " + mSdf.format(emissionRecord.getEnddate()));
                x_indexC += 1;
         //       Log.i("Label",mSdf.format(emissionRecord.getStartdate()) + " to " + mSdf.format(emissionRecord.getEnddate()));
            } else /*SO2*/
            {
...
//        Log.i("labels",labels.size()+"");
        barDataSetC.setColor(Color.CYAN);
        barDataSetS.setColor(Color.MAGENTA);
