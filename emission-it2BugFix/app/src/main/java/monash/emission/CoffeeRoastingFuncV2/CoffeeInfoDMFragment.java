...
public class CoffeeInfoDMFragment extends Fragment {
...
//inflate converts an XML layout file into corresponding ViewGroups and views
        vDisplayUnit = inflater.inflate(R.layout.fragment_coffee_info_dm, container, false);
        c = (CoffeeRoastActivity) getActivity();
        butBack = (Button)vDisplayUnit.findViewById(R.id.but_back_fragment_coffee_info_dm) ;
