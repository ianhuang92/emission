...
/**
 * Created by 80576 on 19/08/2017.
 */

public class CoffeeListViewAdapter extends BaseExpandableListAdapter {
    ...
    public CoffeeListViewAdapter(Context context, List<String> expandableListTitle,
                                       HashMap<String, List<String>> expandableListDetail,int type) {
